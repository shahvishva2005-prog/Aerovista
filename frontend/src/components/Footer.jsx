...
export default function Footer() {
  return (
    <footer className="bg-[#0B132B] border-t border-[#0B132B]">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-16 grid md:grid-cols-12 gap-10">
        <div className="md:col-span-4">
          ...
          <div className="flex gap-3">
            {[Facebook, Instagram, Twitter, Linkedin].map((Icon, i) => (
              <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/10 hover:av-bg-gold hover:text-[#0B132B] text-amber-300 grid place-items-center transition">
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-2 text-white/70 text-sm">
            <li><Link to="/search" className="hover:text-amber-300 transition">Book Flight</Link></li>
            <li><Link to="/destinations" className="hover:text-amber-300 transition">Destinations</Link></li>
            <li><Link to="/fleet" className="hover:text-amber-300 transition">Our Fleet</Link></li>
            <li><Link to="/offers" className="hover:text-amber-300 transition">Offers</Link></li>
          </ul>
        </div>
