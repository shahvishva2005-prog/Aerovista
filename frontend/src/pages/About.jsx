  ...
  return (
    <PageShell title="About AeroVista" subtitle="Connecting Horizons, Delivering Excellence." testId="about-page"
      ...
      <div className="grid lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-6 text-white/75 font-light text-lg leading-relaxed">
        ...
        <div className="glass-light rounded-2xl p-7">
          <div className="text-amber-400 text-[10px] tracking-[0.3em] uppercase mb-4">At a glance</div>
          <ul className="space-y-3 text-white/85 text-sm">
            <li className="flex justify-between"><span className="text-white/50">Headquartered</span><span>Delhi, India</span></li>
            <li className="flex justify-between"><span className="text-white/50">Founded</span><span>2025</span></li>
            <li className="flex justify-between"><span className="text-white/50">Fleet Size</span><span>85+</span></li>
            <li className="flex justify-between"><span className="text-white/50">Destinations</span><span>120+</span></li>
            <li className="flex justify-between"><span className="text-white/50">Pilots</span><span>320+</span></li>
            <li className="flex justify-between"><span className="text-white/50">Cabin Crew</span><span>780+</span></li>
            <li className="flex justify-between"><span className="text-white/50">Hub Airports</span><span>DEL, BOM, BLR</span></li>
          </ul>
        </div>
      </div>
    </PageShell>
